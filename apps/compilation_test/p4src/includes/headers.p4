...
#define ENCODING_FOR_WORDS_BITS 640 // 135 words per header at most  (example 16 words)
#define COUNTERS_FOR_WORDS_BITS 512 // 135 counters per header at most (example 16 counters)
